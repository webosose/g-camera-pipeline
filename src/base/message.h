...
typedef enum MEDIA_MESSAGE
{
    ...
    CMP_MSG__GST_CORE_ERROR_FAILED, // a general error which doesn't fit in any other category. Make
                                    // sure you add a custom message to the error call.
    CMP_MSG__GST_CORE_ERROR_TOO_LAZY, // do not use this except as a placeholder for deciding where
                                      // to go while developing code.
    CMP_MSG__GST_CORE_ERROR_NOT_IMPLEMENTED, // use this when you do not want to implement this
                                             // functionality yet.
    ...
    CMP_MSG__GST_CORE_ERROR_DISABLED, // d30 // used if functionality has been disabled at compile
                                      // time (Since: 0.10.13).
    /* gstreamer library error msg */
    CMP_MSG__GST_LIBRARY_ERROR_FAILED,   // a general error which doesn't fit in any other category.
                                         // Make sure you add a custom message to the error call.
    CMP_MSG__GST_LIBRARY_ERROR_TOO_LAZY, // do not use this except as a placeholder for deciding
    ...
    CMP_MSG__GST_RESOURCE_ERROR_FAILED, // a general error which doesn't fit in any other category.
                                        // Make sure you add a custom message to the error call.
    CMP_MSG__GST_RESOURCE_ERROR_TOO_LAZY,   // do not use this except as a placeholder for deciding
                                            // where to go while developing code.
    ...
    CMP_MSG__GST_RESOURCE_ERROR_OPEN_READ_WRITE, // used when resource cannot be opened for both
    ...
    CMP_MSG__GST_STREAM_ERROR_FAILED,   // a general error which doesn't fit in any other category.
                                        // Make sure you add a custom message to the error call.
    CMP_MSG__GST_STREAM_ERROR_TOO_LAZY, // do not use this except as a placeholder for deciding
                                        // where to go while developing code.
    CMP_MSG__GST_STREAM_ERROR_NOT_IMPLEMENTED, // use this when you do not want to implement this
                                               // functionality yet.
    CMP_MSG__GST_STREAM_ERROR_TYPE_NOT_FOUND,  // used when the element doesn't know the stream's
                                               // type.
    CMP_MSG__GST_STREAM_ERROR_WRONG_TYPE,      // used when the element doesn't handle this type of
                                               // stream.
    CMP_MSG__GST_STREAM_ERROR_CODEC_NOT_FOUND, // used when there's no codec to handle the stream's
                                               // type.
    ...
    CMP_MSG__GST_STREAM_ERROR_FORMAT,  // used when the stream is of the wrong format (for example,
                                       // wrong caps).
    CMP_MSG__GST_STREAM_ERROR_DECRYPT, // used when the stream is encrypted and can't be decrypted
                                       // because this is not supported by the element. (Since:
                                       // 0.10.20)
    CMP_MSG__GST_STREAM_ERROR_DECRYPT_NOKEY, // used when the stream is encrypted and can't be
