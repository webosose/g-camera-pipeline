...
bool testPunchThrough(LSM::CameraWindowManager &CameraWindowManager)
{
    bool result = false;
...
bool testSurface(LSM::CameraWindowManager &CameraWindowManager)
{
    ...
    surface.wlSurface = CameraWindowManager.getSurface();
    surface.width     = 100;
    surface.height    = 100;
