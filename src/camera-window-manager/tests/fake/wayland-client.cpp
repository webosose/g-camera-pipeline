...
void wl_shell_destroy(struct wl_shell *wl_shell) { callAPI("wl_shell_destroy"); }
...
void wl_display_disconnect(struct wl_display *display) { callAPI("wl_display_disconnect"); }
...
void wl_webos_surface_group_compositor_destroy(
    struct wl_webos_surface_group_compositor *wl_webos_surface_group_compositor)
{
...
void wl_region_destroy(struct wl_region *wl_region) { callAPI("wl_region_destroy"); }
...
struct wl_shell_surface *wl_shell_get_shell_surface(struct wl_shell *wl_shell,
...
void wl_webos_shell_surface_set_property(struct wl_webos_shell_surface *wl_webos_shell_surface,
...
void wl_egl_window_destroy(struct wl_egl_window *egl_window) { callAPI("wl_egl_window_destroy"); }
...
void wl_surface_commit(struct wl_surface *wl_surface) { callAPI("wl_surface_commit"); }

void wl_surface_destroy(struct wl_surface *wl_surface) { callAPI("wl_surface_destroy"); }

struct wl_webos_surface_group *wl_webos_surface_group_compositor_get_surface_group(
    struct wl_webos_surface_group_compositor *wl_webos_surface_group_compositor, const char *name)
{
...
void wl_webos_surface_group_attach(struct wl_webos_surface_group *wl_webos_surface_group,
                                   struct wl_surface *surface, const char *layer_name)
{
    callAPI("wl_webos_surface_group_attach");
}

void wl_webos_surface_group_detach(struct wl_webos_surface_group *wl_webos_surface_group,
                                   struct wl_surface *surface)
{
...
struct wl_webos_exported *wl_webos_foreign_export_element(struct wl_webos_foreign *wl_webos_foreign,
                                                          struct wl_surface *surface,
...
struct wl_webos_imported *wl_webos_foreign_import_element(struct wl_webos_foreign *wl_webos_foreign,
...
int wl_webos_exported_add_listener(struct wl_webos_exported *wl_webos_exported,
...
void wl_webos_exported_set_exported_window(struct wl_webos_exported *wl_webos_exported,
                                           struct wl_region *source_region,
                                           struct wl_region *destination_region)
{
    callAPI("wl_webos_exported_set_exported_window");
}

int wl_webos_imported_add_listener(struct wl_webos_imported *wl_webos_imported,
...
void wl_webos_imported_set_surface_alignment(struct wl_webos_imported *wl_webos_imported,
                                             uint32_t format)
{
...
void wl_webos_imported_attach_surface(struct wl_webos_imported *wl_webos_imported,
                                      struct wl_surface *surface)
{
    callAPI("wl_webos_imported_attach_surface");
}

void wl_webos_imported_detach_surface(struct wl_webos_imported *wl_webos_imported,
                                      struct wl_surface *surface)
{
