...
extern "C"
{
    ...
    {
        void (*window_id_assigned)(void *data, struct wl_webos_exported *wl_webos_exported,
                                   const char *window_id, uint32_t exported_type);
    };

    struct wl_webos_imported_listener
    {
        void (*destination_region_changed)(void *data, struct wl_webos_imported *wl_webos_imported,
    ...
    struct wl_shell_surface_listener
    {
        ...
        void (*configure)(void *data, struct wl_shell_surface *wl_shell_surface, uint32_t edges,
    ...
    wl_webos_shell_get_shell_surface(struct wl_webos_shell *wl_webos_shell,
                                     struct wl_surface *surface);
    ...
    struct wl_webos_exported *
    wl_webos_foreign_export_element(struct wl_webos_foreign *wl_webos_foreign,
                                    struct wl_surface *surface, uint32_t exported_type);
    struct wl_webos_imported *
    wl_webos_foreign_import_element(struct wl_webos_foreign *wl_webos_foreign,
                                    const char *window_id, uint32_t exported_type);
    int wl_webos_exported_add_listener(struct wl_webos_exported *wl_webos_exported,
                                       const struct wl_webos_exported_listener *listener,
                                       void *data);
    ...
    int wl_webos_imported_add_listener(struct wl_webos_imported *wl_webos_imported,
                                       const struct wl_webos_imported_listener *listener,
                                       void *data);
