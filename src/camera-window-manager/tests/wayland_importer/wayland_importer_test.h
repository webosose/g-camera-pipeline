...
TEST_F(WaylandImporterTest1, InitializeAndFinalize)
{
    ...
    struct wl_webos_foreign *foreign =
        (struct wl_webos_foreign *)wl_registry_bind(registry, 0, &wl_webos_foreign_interface, 0);
...
protected:
    void SetUp(void)
    {
        ...
        foreign = (struct wl_webos_foreign *)wl_registry_bind(registry, 0,
                                                              &wl_webos_foreign_interface, 0);
