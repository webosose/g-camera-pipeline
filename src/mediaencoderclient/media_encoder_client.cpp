...
MediaEncoderClient::MediaEncoderClient() { CMP_INFO_PRINT("%d %s", __LINE__, __FUNCTION__); }

MediaEncoderClient::~MediaEncoderClient() { CMP_INFO_PRINT("%d %s", __LINE__, __FUNCTION__); }

void MediaEncoderClient::RegisterCallback(ENCODER_CALLBACK_T callback, void *uData)
{
...
bool MediaEncoderClient::Init(const ENCODER_INIT_DATA_T *loadData)
{
    ...
    bufferEncoder->RegisterCbFunction(std::bind(&MediaEncoderClient::Notify, this,
                                                std::placeholders::_1, std::placeholders::_2,
                                                std::placeholders::_3, std::placeholders::_4));
    bufferEncoder->RegisterCallBack(std::bind(&MediaEncoderClient::OnEncodedDataAvailable, this,
                                              std::placeholders::_1, std::placeholders::_2));
