...
{
    return openShmem(phShmem, &shmemKey, 0, 0, 0, 0, MODE_OPEN);
}
...
{
    return readShmem(hShmem, ppData, pSize, ppMeta, pMetaSize, NULL, NULL, READ_FIRST);
}
